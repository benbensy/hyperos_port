...
# 安卓版本
base_android_version=$(grep <build/baserom/images/system/system/build.prop "ro.system.build.version.release" | awk 'NR==1' | cut -d '=' -f 2)
port_android_version=$(grep <build/portrom/images/system/system/build.prop "ro.system.build.version.release" | awk 'NR==1' | cut -d '=' -f 2)
...
# SDK版本
base_android_sdk=$(grep <build/portrom/images/vendor/build.prop "ro.vendor.build.version.sdk" | awk 'NR==1' | cut -d '=' -f 2)
port_android_sdk=$(grep <build/portrom/images/system/system/build.prop "ro.system.build.version.sdk" | awk 'NR==1' | cut -d '=' -f 2)
...
# ROM版本
base_rom_version=$(grep <build/portrom/images/vendor/build.prop "ro.vendor.build.version.incremental" | awk 'NR==1' | cut -d '=' -f 2)

#HyperOS版本号获取
port_mios_version_incremental=$(grep <build/portrom/images/mi_ext/etc/build.prop "ro.mi.os.version.incremental" | awk 'NR==1' | cut -d '=' -f 2)
...
# 代号
base_rom_code=$(grep <build/portrom/images/vendor/build.prop "ro.product.vendor.device" | awk 'NR==1' | cut -d '=' -f 2)
port_rom_code=$(grep <build/portrom/images/product/etc/build.prop "ro.product.product.name" | awk 'NR==1' | cut -d '=' -f 2)
green "机型代号: 底包为 [${base_rom_code}], 移植包为 [${port_rom_code}]" "Device Code: BASEROM: [${base_rom_code}], PORTROM: [${port_rom_code}]"

port_release_codename=$(grep <build/portrom/images/system/system/build.prop "ro.build.version.release_or_codename" | awk 'NR=1' | cut -d '=' -f 2)
...
# Provision
# baseProvision=$(find build/baserom/images/system_ext -type d -name "Provision")
# portProvision=$(find build/portrom/images/system_ext -type d -name "Provision")
# if [[ $port_android_version == "15" ]]; then
#     blue "跳过替换 Provision" "Skip modifying Provision"
# elif [ -d ${baseProvision} ] && [ -d ${portProvision} ]; then
#     blue "正在替换 Provision" "Replacing Provision"
#     rm -rf ./${portProvision}/*
#     cp -rf ./${baseProvision}/* ${portProvision}/
# fi
...
for prop_file in $(find build/portrom/images/vendor/ -name "*.prop"); do
    vndk_version=$(grep <"$prop_file" "ro.vndk.version" | awk "NR==1" | cut -d '=' -f 2)
...
if [ $(grep -c "sm8250" "build/portrom/images/vendor/build.prop") -ne 0 ]; then
...

    {
        ...
        echo "ro.config.miui_desktop_mode_enabled=true"
        echo "persist.sys.precache.enable=true"
        echo "persist.sys.precache.number=3"
        echo "persist.sys.precache.appstrs1=com.sina.weibo,com.ss.android.article.news,com.taobao.taobao,com.smile.gifmaker"
        echo "persist.sys.precache.appstrs2=com.ss.android.ugc.aweme,com.tencent.mm,tv.danmaku.bili"
        echo "persist.sys.precache.appstrs3=com.miui.weather2"
        echo "persist.sys.precache2.number=1"
        echo "ro.config.miui_activity_Magic_Point=true"
        echo "persist.miui.auto_ui_enable=true"
        echo "persist.sys.render_turbo=true"
        echo "persist.sys.smart_gc.enable=true"
        echo "persist.sys.smart_gc.packages=com.miui.home,com.android.systemui"
        echo "persist.sys.trim_rendernode.enable=true"
        echo "persist.sys.miui_animator_sched.sched_threads=2"
...
# if [[ ${port_rom_code} == "sheng" ]] || [[ ${port_rom_code} == "liuqin" ]] || [[ ${port_android_version} == "15" ]]; then
...
# else
#     blue "左侧挖孔灵动岛修复" "StrongToast UI fix"smali
...
# blue "开启平板专区" "pad"
# patch_smali "Settings.apk" "SettingsFeatures.smali" ".method public static shouldShowAutoUIModeSetting()Z\n    .registers 4\n\n    .line 1038\n    sget-object v0, Lmiui\/os\/Build;->DEVICE:Ljava\/lang\/String;\n\n    const-string\/jumbo v1, \"yudi\"\n\n    invoke-virtual {v1, v0}, Ljava\/lang\/String;->equals(Ljava\/lang\/Object;)Z\n\n    move-result v1\n\n    const\/4 v2, 0x1\n\n    const\/4 v3, 0x0\n\n    if-nez v1, :cond_18\n\n    const-string v1, \"babylon\"\n\n    invoke-virtual {v1, v0}, Ljava\/lang\/String;->equals(Ljava\/lang\/Object;)Z\n\n    move-result v0\n\n    if-eqz v0, :cond_16\n\n    goto :goto_18\n\n    :cond_16\n    move v0, v3\n\n    goto :goto_19\n\n    :cond_18\n    :goto_18\n    move v0, v2\n\n    :goto_19\n    const-string\/jumbo v1, \"persist.miui.auto_ui_enable\"\n\n    .line 1039\n    invoke-static {v1, v3}, Landroid\/os\/SystemProperties;->getBoolean(Ljava\/lang\/String;Z)Z\n\n    move-result v1\n\n    if-eqz v1, :cond_25\n\n    if-eqz v0, :cond_25\n\n    goto :goto_26\n\n    :cond_25\n    move v2, v3\n\n    :goto_26\n    return v2\n.end method" ".method public static shouldShowAutoUIModeSetting()Z\n    .registers 2\n\n    const-string\/jumbo v0, \"persist.miui.auto_ui_enable\"\n\n    const\/4 v1, 0x0\n\n    .line 1023\n    invoke-static {v0, v1}, Landroid\/os\/SystemProperties;->getBoolean(Ljava\/lang\/String;Z)Z\n\n    move-result v0\n\n    return v0\n.end method"
...
rm -rf build/portrom/images/mi_ext/product/data-app/*
...
if [[ ${is_eu_rom} == true ]]; then
    ...
    debloat_apps=("MSA" "mab" "Updater" "MiuiUpdater" "MiService" "MIService" "SoterService" "Hybrid" "AnalyticsCore" "MSLgRdp")
    ...
    mkdir -p tmp/app
    kept_data_apps=("MIUISecurityManager" "MIUIThemeStore" "DownloadProviderUi" "VirtualSim" "ThirdAppAssistant" "GameCenter" "Video" "Weather" "DeskClock" "Gallery" "SoundRecorder" "ScreenRecorder" "Calculator" "CleanMaster" "Calendar" "Compass" "Notes" "MediaEditor" "Scanner" "SpeechEngine" "wps-lite" "Creation" "Huanji" "MIUIMusic" "Email" "Duokan" "MiRemoteControl")
...
for prop in $(find build/baserom/images/product build/baserom/images/system -type f -name "build.prop"); do
    base_rom_density=$(grep <"$prop" "ro.sf.lcd_density" | awk 'NR==1' | cut -d '=' -f 2)
...
# 修复 Xiaomi Pad Keyboard
awk '/<\/features>/ {
    print "    <!-- whether support IIC keyboard -->";
    print "    <bool name=\"support_iic_keyboard\">true</bool>";
}1' build/portrom/images/product/etc/device_features/elish.xml > build/portrom/images/product/etc/device_features/temp.xml
mv build/portrom/images/product/etc/device_features/temp.xml build/portrom/images/product/etc/device_features/elish.xml
...
#自定义替换
if [[ ${port_rom_code} == "dagu_cn" ]] || [[ ${port_rom_code} == "sheng" ]] || [[ ${port_rom_code} == "liuqin" ]] || [[ ${port_rom_code} == "muyu" ]]; then
    ...
    if [[ -d devices/pad/overlay/product/etc ]]; then
        cp -rf devices/pad/overlay/product/etc/* build/portrom/images/product/etc/
    fi
