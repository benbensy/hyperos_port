...
if [ -d ${baseProvision} ] && [ -d ${portProvision} ]; then
    blue "正在替换 Provision" "Replacing stock Provision"
    rm -rf ./${portProvision}/*
...
if [[ ${port_android_version} != "15" ]]; then
    patch_smali "PowerKeeper.apk" "DisplayFrameSetting.smali" "unicorn" "elish"
fi
if [[ ${is_eu_rom} == true ]]; then
